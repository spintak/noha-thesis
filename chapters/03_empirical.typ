...
The analysis will be guided by the Cynefin Framework, which provides a lens for understanding the complexity of knowledge management in humanitarian contexts, and the Theory of Communicative Disenfranchisement, which offers insights into the power dynamics and marginalization of local voices in knowledge production. 
