...
= Methodology
This research utilizes a qualitative case study to investigate the communicative processes that shape knowledge management within @cvtl, serving as an entry point to analyze the broader "documentary reality" 
(Smith as cited in #cite(<escobarEncounteringDevelopment>, form: "author"), #cite(<escobarEncounteringDevelopment>, form: "year"), p. 107) created by donor institutions in the humanitarian sector.
...
The conceptual structures for this thesis concern decolonial theory (Dorothy Smith, Arturo Escobar, Paul Sillitoe, Alan Bicker, and Johan Pottier), the @tcd (Elizabeth A. Hintz and Kristina M. Sharp), and the Cynefin® framework (Dave Snowden and Alessandro Rancati) to analyze the dynamics of knowledge production and power in the humanitarian sector.
