...
One current role of INGOs is to function as intermediaries between larger donors (traditional funders like governments) and the humanitarian organizations to be funded @doaneINGOProblem2024[p. 66]. 
...
This dynamic is still present in the humanitarian sector today, where the Global North continues to exert power and control over the Global South through the management of information and finances. There is still "a form of governmentality that in marking out a 'subject nation'"---in this case the communities and local humanitarians of the Global South--- in which the Global North "appropriates, directs and dominates its various spheres of activity" [Homi Bhaba as cited in @escobarEncounteringDevelopment[p. 9]]. In their chapter 'Evaluation and the White Gaze in International Development', authors Sadaf Shallwani and Shama Dossa synthesize this very dynamic as it manifests in development work, the sister of the humanitarian sector:
