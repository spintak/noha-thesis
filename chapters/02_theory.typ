...
/ IFRC: International Federation of Red Cross and Red Crescent Societies: Geneva-based organization that oversees the development of the National Societies across the world and coordinates large-scale disaster response
...
/ Modernization: The "adoption of the 'right' values, namely those held by the white minority... and, in general, those embodied in the ideal of the cultivated European" through socio-cultural restructuring @escobarEncounteringDevelopment[p. 43] and industrialization; entirely analagous with "conceptual categories and Western assumptions" @manzoModernist[p. 3];  
...
The Cynefin® framework was "designed to manage anthro-complexity, or complexity in human systems" @CynefinFieldGuideActual[p. 57] particularly in the world of corporate business but its focus on times of crisis and uncertainty makes it a useful tool for understanding the challenges of knowledge management in humanitarian contexts. 
...
Diane Doane, author of "The INGO Problem: privelege, power, and renewal", explains that one current role of INGOs is to function as intermediaries between larger donors (traditional funders like governments) and the humanitarian organizations to be funded @doaneINGOProblem2024[p. 66]. 
