...
In Arturo Escobar's seminal work, "Encountering Development: The Making and Unmaking of the Third World", he asks his reader not to "overlook the ways in which development operates as an arena of cultural contestation and identity construction" @escobarEncounteringDevelopment[p. 15]. Western sense-making has not only shaped the way that development and humanitarian aid are conceptualized, but also how they are evaluated and measured @escobarEncounteringDevelopment[p. 15]. The "problematization of poverty" that has been central to the development project is also central to the humanitarian system, where affected communities are framed as problems to be solved and data to be measured @escobarEncounteringDevelopment[p. 17]. And so, the "professionalization of development knowledge and the institutionalization of development practices" was a key aspect of 'solving' the problem irrespective of context and conditions @escobarEncounteringDevelopment[p. 17].
The humanitarian system has inherited this legacy of Western sense-making, shaped by colonial capitalist constructions of 'developed' and 'underdeveloped', 'First World' and 'Third World', and it is from "this privileged space that economics pervaded the entire practice of development" @escobarEncounteringDevelopment[p. 18]. The so-called "rational techniques---planning, methods of measurement and assesment, professional knowledges, institutional practices, and the like--- organizes both forms of knowledge and types of power, relating one to the other, in the construction and treatment" of humanitarian and development issues @escobarEncounteringDevelopment[p. 18].
...
The "western-derived", ill defined notion of 'capacity'---a trait local humanitarians are assumed to lack--- lays the foundation for paternalism through intervention and oversight by Global North institutions @doaneINGOProblem2024[p. 50]. 
