...
While these donors praise the value of "empowerment" and "localization", the extent of agency granted to the local "partner" organization and their staff is limited by the standardized reporting mechanisms that are designed to satisfy donor requirements rather than to empower local humanitarian workers to use their context-based knowledge and expertise. Johar argues that in these "goal-coded systems", orientation is overlooked.
...
Individuals become "custodians of comprehension" rather than "catalysts for transformation" @JoharCatalyst. 
In the humanitarian sector, this can manifest in the way that local humanitarian workers are required to fill out standardized reports and forms to satisfy donor requirements, rather than being able to use their local knowledge and expertise to drive meaningful change in their communities. 
...
This bureaucratization of information can lead to a disconnect between the lived experiences of local humanitarian workers and the information that is being reported to donors, which can ultimately impact the effectiveness of humanitarian interventions.
