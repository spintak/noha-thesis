...
Johar argues that "goal-coded systems"---systems that are designed to achieve specific goals---can lead to a "crisis of orientation" for the users @JoharGoalCodedSystemsCrisis. 
...
Who "produces knowledge about the Third World" and "from what spaces"? [Chandra Mohanty as referenced in @escobarEncounteringDevelopment[p. 8]] 
...
Dr. Syed Farid Alatas explains that although current discourse labels the world today as "post-colonial," what is more accurate is the term "neo-colonial" @WDF2026. "This was said by Sukarno in 1955 at the Bandung Conference---that colonialism has not gone away. Neo-colonialism means colonialsm without being politically ruled by Europeans, but in terms of culture, militaryy, political, and intellectual dimensions, we are still very much controlled" @WDF2026.
