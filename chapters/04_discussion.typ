...
One interviewee was the founder of a non-profit charity that provides direct funding to local humanitarian organizations in over 70 countries without the requirement of standardized reporting, instead trust is cultivated through relationship-building with these local humanitarians. 
This founder called out the "limousine liberals"--the industry giants that siphon off funds intended to support work in affected communities. 
...
This founder's accusations are not unwarranted, in fact, the OECD has "finally acknowledged" that "giving through INGOs"-- or "fund-emediaries", as some have dubbed them-- "actually costs more" than giving directly to community-based organizations @doaneINGOProblem2024[p. 61]. 
