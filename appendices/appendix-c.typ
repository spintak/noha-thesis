...
These Principles and Rules are adopted within the statutory framework of the Movement.  These Principles and Rules are adopted by member National Societies and their International Federation and will be presented to the International Conference of the Red Cross and Red Crescent in 2015. They shall be a part of the future Movement-wide #text(weight: "bold", "coordination and cooperation framework.")

@IFRCprinciples[p. 3]


Our assistance adheres to the Movement’s Fundamental Principles: it is based on humanity, respects impartiality, neutrality, and independence, is in conformity with unity and universality and builds upon voluntary service.

1. We, the National Societies and the International Federation, consider that all persons affected by disasters are entitled to receive assistance, consistent with their needs and priorities. 

2. #text(weight: "bold", "We respect the dignity of all people affected by disasters,  including their meaningful involvement in decisions that affect their lives and livelihoods.") 

3. #text(weight: "bold", "We commit to protect people affected by disasters, particularly those made vulnerable by any form of discrimination.") 

4. We have the duty to bring humanitarian assistance to  those in need. We partner with states, which have the primary responsibility to meet the needs of disaster-affected people in their countries. 

5. We advocate on behalf of people at risk and affected by  disasters for increased action to address their vulnerabilities and unmet humanitarian needs. 

6. We increase and expand our assistance through mobilising our network. We commit that all international assistance provided by a National Society or the International Federation is with the consent of the National Society of the disaster-affected country.

7. #text(weight: "bold", "We are each other’s primary and preferred partners. We  pursue operational partnerships with external actors – consistent with our Fundamental Principles – to further increase operational reach, scale and effectiveness.") 

8. We ensure that our assistance is well coordinated among  ourselves and with relevant external actors. 

9. #text(weight: "bold", "We ensure that our assistance is appropriate, efficient, effective, and accountable, and we support the transition from relief to recovery for disaster affected people.") 
...
- 1.2 Preparedness measures may include but should not be  limited to: 
  ...
  - d. Conducting and concluding pre-disaster meetings  and agreements; 
  - e. Convening and participating in simulation exercises  with relevant partners; 
  - f. #text(weight: "bold", "Building necessary volunteer, staff and organizational capacity to provide timely disaster response;") and 
  - g. #text(weight: "bold", "Building necessary organizational capacity to receive and account for international assistance.")

- 1.3 National Societies shall strive to continuously strengthen their auxiliary role to the public authorities in the humanitarian field, including through #text(weight: "bold", "establishing clear roles and mandates as set out in applicable legislation, policies and plans.")

- 1.4. National Societies shall encourage and support the  relevant public authorities to #text(weight: "bold", "review and develop legislation, policies and plans for disaster management, including by using the ")#link("https://www.icrc.org/sites/default/files/external/doc/en/assets/files/red-cross-crescent-movement/31st-international-conference/idrl-guidelines-en.pdf", "Guidelines for the domestic facilitation and regulation of international disaster relief and initial recovery assistance (IDRL Guidelines)")#text(weight: "bold", " to strengthen their  overall legal, policy or institutional frameworks to both regulate and facilitate disaster assistance.") 
...
- 1.7 #text(weight: "bold", "National Societies shall inform the International Federation") of any sudden or slow-onset disaster for which #text(weight: "bold", "international assistance may be required and provide, as soon as possible, relevant information") including: 
  - a. The nature of the disaster, estimated extent of human and physical impact, and the likely future development of the situation; 
  - b. #text(weight: "bold", "Any preliminary assessment of needs and the immediate priorities for assistance;") 
  - c. Actions taken thus far by the National Society and  its partners; 
  - d. Actions taken by public authorities or other actors;  and 
  - e. #text(weight: "bold", "All requests for international humanitarian assistance.")

- 1.9 When international assistance is sought to respond to  the humanitarian needs of people affected by disaster, #text(weight: "bold", "the National Society should request from the International Federation the following support as necessary:") 
  - a. Immediate #text(weight: "bold", "financial support") from the International  Federation’s Disaster Relief Emergency Fund; 
  - b. The launch of an Emergency Appeal on behalf of the  National Society; 
  - c. Request the deployment of global/regional disaster  #text(weight: "bold", "response tools;") 
  - d. #text(weight: "bold", "Request technical, managerial or additional coordination support.") 

- 1.10 The National Society may also request bilateral assistance from National Societies #text(weight: "bold", "in accordance with established frameworks for coordination agreed with the International Federation.") 
...
- 1.13 #text(weight: "bold", "The National Society shall work with the International  Federation to ensure that international Red Cross Red Crescent assistance is effectively coordinated between and among Movement and non-Movement actors at both strategic and technical levels.") 

- 1.15 The National Society shall #text(weight: "bold", "ensure systems, procedures  and appropriate processes are in place to be able to account for and report regularly on the funds and in-kind resources received and expenditures it incurs.") 

- 1.16 #text(weight: "bold", "The National Society shall share information through established Movement coordination systems on the following:") 
  - a. #text(weight: "bold", "Results of on-going needs and risks assessments;") 
  - b. #text(weight: "bold", "Progress against operational plans and capacity  strengthening;")
  - c. Priorities of the government and activities of other actors in country; 
  - d. Any operational or institutional #text(weight: "bold", "concerns or risks,  including plans for using unspent funds;") and 
  - e. #text(weight: "bold", "Emerging gaps in resources and operational capacities.")

- 1.20 In disasters affecting the border areas of neighbouring countries the concerned National Societies shall ensure #text(weight: "bold", "continuous exchange of information between themselves either directly or through the International Federation and, where relevant, collaborate") to improve access to disaster-affected people or improve the quality of humanitarian assistance provided. 
...
- 2.1 #text(weight: "bold", "In order to ensure efficient and coordinated international assistance, National Societies shall work together with the International Federation to, where applicable:") 
  ...
  - c. Conclude pre-disaster #text(weight: "bold", "agreements on the provision  of humanitarian assistance and cooperation, and share these with the Movement partners through the International Federation;") 
  - d. Ensure the pre-positioning of relevant relief stocks and surge #text(weight: "bold", "capacities;") 
  - e. #text(weight: "bold", "Support the coordinated development of the global, regional and national disaster response mechanisms and surge capacity tools;") 
  - f. Regularly monitor hazard information to guide  planning and to alert partners on potential upcoming humanitarian assistance needs; and 
...
- 2.5 National Societies shall #text(weight: "bold", "prioritise Red Cross Red Crescent channels") when providing international humanitarian assistance. #text(weight: "bold", "Non-Movement channels") of assistance (including donations to non-Movement partners) #text(weight: "bold", "shall only be used when agreed") with the National Society in the affected country. #text(weight: "bold", "National Societies will inform the International Federation.") 
...
- 2.9 Where National Societies have agreed operational  partnerships with external actors they shall coordinate with the National Society in the disaster affected country and other relevant Movement components to #text(weight: "bold", "ensure common standards and coherent approaches to humanitarian assistance.") 

- 2.10 If National Societies wish to transfer relief stocks which  are reserved for an International Federation operation, they may do so #text(weight: "bold", "only with the prior agreement of the International Federation.") 

- 2.11 National Societies providing assistance shall seek to  allocate adequate resources to improve disaster preparedness and reduce disaster risks when responding to disasters.
...
- 3.6 #text(weight: "bold", "When the International Federation receives a request for  international assistance from a National Society, it may:") 
  ...
  - c. Deploy global and regional disaster response #text(weight: "bold", "mechanisms and surge capacity tools;") 
  - d. #text(weight: "bold", "Provide support for the preparation of emergency  plans of action;") 
  - e. #text(weight: "bold", "Provide or facilitate the provision of other services requested") by the National Society; 
  - f. Perform its role as set out in any pre-disaster #text(weight: "bold", "agreement;") and/or 
  - g. #text(weight: "bold", "Propose other international assistance mechanisms  as may be relevant to the specific context.")

- 3.7 Where the National Society does not intend to request international humanitarian assistance, #text(weight: "bold", "the International Federation may, in consultation with the affected National Society, send representatives to the disaster-affected country to gather information and assist") the National Society in its response. 
...
- 3.11 The International Federation shall #text(weight: "bold", "encourage and facilitate operational consortia and other forms of alliances among National Societies which support coordinated and efficient action.") 

- 3.12 The International Federation shall support and promote regional responses as appropriate through #text(weight: "bold", "regional programming approaches, tools and funding mechanisms.") 

- 3.13 #text(weight: "bold", "As the official representative of the National Societies  in the international field,") the International Federation shall ensure the representation and coordination with international and regional humanitarian organizations. The International Federation #text(weight: "bold", "may temporarily delegate international representation roles to National Societies.")

- 3.14 The International Federation shall #text(weight: "bold", "provide the direction and management over any deployed global and regional surge capacity tools") agreed with the receiving National Society. The International Federation #text(weight: "bold", "may assume any other direct operational role") as agreed with the National Society in the disaster-affected country. 

- 3.15 The International Federation shall seek to ensure that  global humanitarian diplomacy approaches to disaster response are #text(weight: "bold", "strategic and coordinated") with other Movement components in the interest of addressing the key humanitarian concerns of the disaster-affected people. 

- 3.16 In the context of international humanitarian assistance, #text(weight: "bold", "the International Federation shall work with the National Society in the affected country to promote and protect its organizational objectives and interests.") 

- 3.17 The International Federation will #text(weight: "bold", "disseminate relevant  operational information,") including plans of action, appeal coverage, the status of expenditures and commitments, activities undertaken, unmet needs, and #text(weight: "bold", "potential operational and reputational risks.") 

- 3.18 The International Federation, in agreement with the  concerned National Societies #text(weight: "bold", "shall ensure that realtime evaluations are commissioned for major response operations and reviews and evaluations are carried out for other operations, on behalf of all operational partners, and that their findings, recommendations and agreed action points are disseminated and followed up.") 
...
- 4.2 National Societies and the International Federation  shall #text(weight: "bold", "develop responsible transition and handover strategies based on the needs and priorities of disaster-affected people, available funding and local capacities.")
  ...
  To ensure #text(weight: "bold", "appropriate and timely") relief and recovery programming National Societies should: 
  
    - a. Assess recovery needs and commence planning  within the immediate response; 
    
    - b. #text(weight: "bold", "Engage in participatory planning with affected communities and other relevant actors;") and 
...
=== Planning, monitoring, evaluation, and reporting
  ...
  - 5.6 National Societies and the International Federation  shall #text(weight: "bold", "put in place mechanisms for timely and effective needs assessment, planning, monitoring, evaluation and reporting.") This may include #text(weight: "bold", "building the capacity") of staff and volunteers to undertake: 
      ...
      - b. #text(weight: "bold", "Assessment") of the capacities within the communities to respond and provide assistance; 
      - c. #text(weight: "bold", "Assessment") of the impact of the disaster on local  markets and social capital; 
      - d. Primary and secondary data #text(weight: "bold", "analysis,") and consideration of cross-cutting issues relevant to the context; 
      - e. #text(weight: "bold", "Strategic and operational planning;") and 
      - f. #text(weight: "bold", "Monitoring, evaluation and reporting activities.") 

  - 5.7 National Societies and the International Federation  shall utilize #text(weight: "bold", "participatory approaches to planning, monitoring, evaluation and learning.") They shall ensure that good practices and evaluation #text(weight: "bold", "reports are disseminated and agreed recommendations are acted upon.")
...
- 5.14 #text(weight: "bold", "National Societies shall cooperate with the International Federation to use and develop joint operational support systems and shared service platforms for effective use of resources and better service delivery.") 

- 5.15 #text(weight: "bold", "National Societies and the International Federation  shall strive to negotiate donor agreements which are consistent with Federation standards where applicable and which have realistic outcomes and deliverables for the operational context and capacities.")

- 5.16 When changes must be made to operational plans or  donor agreements to better respond to the changing needs of the disaster-affected people, #text(weight: "bold", "the National Societies or the International Federation shall communicate these changes to concerned donors and other stakeholders in a timely manner.") 

- 5.17 #text(weight: "bold", "National Societies and the International Federation  shall meet all donor requirements to which they have agreed, including timely production of accurate and coherent financial and narrative reporting.") 
...
- 5.21 #text(weight: "bold", "National Societies and the International Federation  shall put in place systems and procedures, including adequate control and oversight mechanisms, codes of conduct, policies and training, to prevent acts of fraud or corruption.") 
